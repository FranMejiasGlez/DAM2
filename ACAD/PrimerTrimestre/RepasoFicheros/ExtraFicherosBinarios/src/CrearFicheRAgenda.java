 ...
 */
public class CrearFicheRAgenda {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i <= 1; i++) {
                ...
                rADao.escribir(persona);
            }
            
        } catch (FileNotFoundException ex) {
            System.out.println("Fichero RAgenda.dat no encontrado");
        } catch (IOException ex) {
            System.out.println("Error de E/S en fichero RAgenda.dat");
        }
    }
}
